import { Alert, Checkbox, Tooltip, message } from 'antd'
...
function Spotconnectiondetails() {
  ...
  const handleSubmit = (event) => {
    ...
    inputValues.exchange = "Binance_SPOT"
      ...
      <div className="grid lg:grid-cols-2">
          ...
          <form class="bg-white  rounded px-8 pt-6 pb-8  mr-30 ml-36" onSubmit={handleSubmit}>
            ...
            <div class="items-center">
              <div className="bg-colorSecondary rounded-full align items-center border-solid drop-shadow-xl flex flex-row break-words p-1 justify-center mb-3  mx-2 text-black">
                ...
                <h4 className="text-2xl font-extrabold ">Spot</h4>
              </div>
            </div>
            ...
            <Checkbox>I intend to use this API key to trade</Checkbox>
            <Alert
              message="To increase your security, connect to your exchange with Profitsla whitelisted IPs. Copy the IPs and paste them into your exchange while creating the new API keys."
              className="mt-5 mb-5"
              type="info"
              showIcon
            />
            ...
            <div class="items-end flex justify-end">
              <button class="bg-[#3b3b3b] rounded-3xl  mx-2 hover:text-colorPrimary text-white font-bold py-2 px-4  focus:outline-none focus:shadow-outline">
        ...
        <div class="text-center items-center mt-24 ">
          ...
          <button type="button" className="p-2 bg-colorPrimary rounded-xl mt-5">
           <Link to={"https://www.binance.com/en/support/faq/how-to-create-api-keys-on-binance-360002502072"}>Learn How</Link> 
          </button>
        </div>
      </div>
    </>
